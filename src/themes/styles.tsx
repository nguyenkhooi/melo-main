...
export const fgTransColor = (opacity) => (props) =>
  `${props.theme.fgTrans}${opacity})`;
export const bgTransColor = (opacity) => (props) =>
  `${props.theme.bgTrans}${opacity})`;
export const primary = (props) => props.theme.primary;
